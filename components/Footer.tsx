import FooterLinks from "../api/Footer.json";
    ...
    >
      ...
      <SectionContainer>
              ...
              {FooterLinks.map((segment: any) => {
                return (
                  <div key={`footer_${segment.title}`}>
                    <h3 className="text-sm text-gray-300 dark:text-dark-400">
                      {segment.title}
                    </h3>
        ...
        <div className="mt-32 border-t border-gray-100 dark:border-dark-600 pt-8 flex justify-between">
          <p className="text-base text-gray-400 dark:text-dark-400">
